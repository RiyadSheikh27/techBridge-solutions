    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='items', to='checkout.order')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['order', 'is_active'], name='checkout_pr_order_i_35d8d7_idx'),
        ),
        migrations.AddIndex(
            model_name='productreview',
            index=models.Index(fields=['user', 'is_active'], name='checkout_pr_user_id_d308ec_idx'),
        ),
    ]
